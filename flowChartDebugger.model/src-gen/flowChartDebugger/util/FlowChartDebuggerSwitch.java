 ...
 * @generated
 */
public class FlowChartDebuggerSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FlowChartDebuggerSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case FlowChartDebuggerPackage.STEP: {
		...
		case FlowChartDebuggerPackage.TERMINAL: {
			Terminal terminal = (Terminal) theEObject;
			T result = caseTerminal(terminal);
			if (result == null)
				result = caseStep(terminal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FlowChartDebuggerPackage.PROCESS: {
			flowChartDebugger.Process process = (flowChartDebugger.Process) theEObject;
			T result = caseProcess(process);
			if (result == null)
				result = caseStep(process);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FlowChartDebuggerPackage.INPUT_OR_OUTPUT: {
			InputOrOutput inputOrOutput = (InputOrOutput) theEObject;
			T result = caseInputOrOutput(inputOrOutput);
			if (result == null)
				result = caseStep(inputOrOutput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case FlowChartDebuggerPackage.START: {
			...
			if (result == null)
				result = caseTerminal(start);
			if (result == null)
				result = caseStep(start);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FlowChartDebuggerPackage.STOP: {
			...
			if (result == null)
				result = caseTerminal(stop);
			if (result == null)
				result = caseStep(stop);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseProcess(flowChartDebugger.Process object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Input Or Output</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Input Or Output</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInputOrOutput(InputOrOutput object) {
		return null;
	}
