...
/**
 * This is the item provider adapter for a {@link flowChartDebugger.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPreviousStepPropertyDescriptor(object);
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						FlowChartDebuggerPackage.Literals.STEP__NAME, true, false, false,
	...
	protected void addNextStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Step_nextStep_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Step_nextStep_feature", "_UI_Step_type"),
						FlowChartDebuggerPackage.Literals.STEP__NEXT_STEP, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Previous Step feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPreviousStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Step_previousStep_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Step_previousStep_feature",
								"_UI_Step_type"),
						FlowChartDebuggerPackage.Literals.STEP__PREVIOUS_STEP, true, false, true, null, null, null));
	}
	...
	protected void addHasRunPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Step_hasRun_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Step_hasRun_feature", "_UI_Step_type"),
						FlowChartDebuggerPackage.Literals.STEP__HAS_RUN, true, false, false,
